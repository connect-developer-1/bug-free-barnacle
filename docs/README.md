...
- [Role-Based Onboarding Checklist](octoacme-role-onboarding-checklist.md) — Role-specific onboarding activities to accelerate ramp-up
- [Collaboration Scenarios](octoacme-collaboration-scenarios.md) — Examples of cross-role interactions and handoffs
